...
export const TABS: DocTab[] = [
  {
    ...
    sections: [
      ...
      { id: "disc-produto", label: "4 · Contratos de Design" },
      { id: "disc-ref-design", label: "Critérios de marca", sub: true },
      ...
      { id: "disc-bench-produto", label: "7.1.1 Produto", sub: true },
      { id: "disc-bench-marca", label: "7.1.2 Marca", sub: true },
      { id: "disc-pesquisa-entrevistas", label: "7.2 Entrevistas", sub: true },
      { id: "disc-ent-prep", label: "7.2.1 Preparação", sub: true },
      { id: "disc-ent-perfis", label: "7.2.2 Perfis", sub: true },
      { id: "disc-ent-logistica", label: "7.2.3 Logística", sub: true },
      { id: "disc-ent-individuais", label: "7.2.4 Individuais", sub: true },
